...
/******************************************************************************/
/* Exported functions for USART3 in HAL layer */
/******************************************************************************/
...
hal_uart_handle_t *mx_usart3_uart_init(void)
{
  ...
  **/
  ...
  /* USART3 interrupt: enabled here so TX/RX can be driven fully asynchronously
     (HAL_UART_Transmit_IT / HAL_UART_ReceiveToIdle_IT) without blocking the
...
void mx_usart3_uart_deinit(void)
{
  ...
  HAL_GPIO_DeInit(HAL_GPIOB, HAL_GPIO_PIN_3 | HAL_GPIO_PIN_4);
}
